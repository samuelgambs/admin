 <?php
  ...
  $sql = "     SELECT a.nomefantasia, a.Estado, a.idclinica,
                 ...
                 Round(u.total,0) as total_paciente, t2.faltosos_atendidos, Round(t.total * 100 / u.total,2) as faltosos_sob_pacientes, t.faltosos_agendados, t.faltosos_atendidos,
       ...
       LEFT JOIN (SELECT  qtd_falta_mes, qtd_marcacoes_mes, indice_falta, inscricao,data_inclusao as data_falta_pmp
        ...
        LEFT JOIN (SELECT dataref,total_indic,total_contemplado,data_arquivo, inscricao
               ...
               ON am.inscricao = CASE
                                      ...
                                      ELSE substring(a.CNPJ,1,9)
                                   END
      LEFT JOIN (SELECT dataref, total_indic, total_permitido, total_contemplado, inscricao
