...
$query_sql_soma_nacional_mp = $MySQLi->query($sql_soma_nacional_mp) or trigger_error($MySQLi->error, E_USER_ERROR);  
$row_sql_soma_nacional_mp = $query_sql_soma_nacional_mp->fetch_object();
$total_orcamentos_nacional = $row_sql_soma_nacional_mp->total_orcamentos; 
$total_documentacao_nacional = $row_sql_soma_nacional_mp->total_documentacao; 
$total_lucro_nacional = $row_sql_soma_nacional_mp->total_lucro;
$total_inicios_nacional = $row_sql_soma_nacional_mp->total_inicios;
$total_pacientes_mp_nacional = $row_sql_soma_nacional_mp->total_pacientes_mes_passado;
$total_flutuantes_nacional = $row_sql_soma_nacional_mp->total_flutuantes;
$total_agendados_faltosos_nacional =  $row_sql_soma_nacional_mp->total_agendados_faltosos;
$total_atendidos_faltosos_nacional = $row_sql_soma_nacional_mp->total_atendidos_faltosos;
$total_a_receber_mp_nacional = $row_sql_soma_nacional_mp->total_a_receber;
$total_em_atraso_mp_nacional = $row_sql_soma_nacional_mp->total_em_atraso;
$total_pago_mp_nacional = $row_sql_soma_nacional_mp->total_pago;