...
<head>
  ...
  <title><?php echo $nomefantasia?> Documentações</title>
	...
	window.onresize = function(){	
     ...
     startDrawingLinOrc = function(){
      ...
      var data = google.visualization.arrayToDataTable(data_LinDoc);
        ...
        var options = {
          title: '<?php echo $nomefantasia?> Histórico de Documentações',
          hAxis: {title: 'Mês',  titleTextStyle: {color: '#333'}},
          vAxis: {minValue: 0}
        };

        var chart = new google.visualization.LineChart(document.getElementById('lin_documentacao'));
