...
<head>
  ...
  <title><?php echo $nomefantasia?> Orçamentos</title>
    ...
    var data_LinOrc = [
     ...
     startDrawingLinOrc = function(){
      ...
      var data = google.visualization.arrayToDataTable(data_LinOrc);
        ...
        var options = {
          title: '<?php echo $nomefantasia?>, Histórico de Aproveitamento',
