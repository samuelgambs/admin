...
<head>
  ...
  <title><?php echo $nomefantasia?> Cancelamentos</title>
  ...
  var data_LinCanc = [
      ...
      var data = google.visualization.arrayToDataTable(data_LinCanc);
        ...
        var options = {
          title: '<?php echo $nomefantasia?>, Histórico de Cancelamentos de Ficha',
          hAxis: {title: 'Mês',  titleTextStyle: {color: '#333'}},
          vAxis: {minValue: 0}
        };

        var chart = new google.visualization.AreaChart(document.getElementById('lin_cancelamentos'));
