...
<head>
  ...
  <title><?php echo $nomefantasia?> Total de Faltosos</title>
    ...
    var data_LinFaltAge = [
                        ['Data Referência', 'Faltosos Agendados','Média Nacional','Media Regional' ],
                                       <?php while ($row_lin_faltosos_agendados = $query_busca_lin_qtde_faltosos2->fetch_object()) {
                                    ?>
                                    ['<?php echo $row_lin_faltosos_agendados->dataref; ?>', <?php echo round($row_lin_faltosos_agendados->faltosos_agendados); ?>,<?php echo round($row_lin_faltosos_agendados->media_nacional_agendados); ?>,<?php echo round($row_lin_faltosos_agendados->regional_agendados); ?>   ],
                                                                     <?php }     ?>
    ];
	 startDrawingLinFalt = function(){
      google.load("visualization", "1", {packages:["corechart"],callback: drawChart});
      function drawChart() {
      var data = google.visualization.arrayToDataTable(data_LinFaltAge);

        var options = {
          title: '<?php echo $nomefantasia?> Histórico de Faltosos Agendados',
