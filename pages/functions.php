                       ...
                       <a data-toggle="modal" data-target="#modal_<?php echo $labellink ?>" href="#modal_<?php echo $labellink ?>" id="button_<?php echo $labellink ?>">
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="huge">   <?php  if  ($flag != 'normal')   {  if ($flag != 'invertido') {  if ($flag != 'aproveitamento-mp')  {if ($label != 'Pacientes')  {?>
                                      ...
                                      <?php }
                                       ...
                                       <b data-toggle="tooltip" data-placement="bottom" title="<?php if ($label == 'Pacientes') echo 'Total de Pacientes'; else echo 'Porcentagem de Inícios 
                                     Sob o Total de Orçamentos'; ?>" ><?php  if ($flag != 'ma') echo $porc_mp; else echo $porc_parcial_mes; ?><?php if  ($label != 'Pacientes') echo '%';?></b>
                                        <?php } ?>
                                ...
                                <div class="col-xs-9 text-right tooltip-demo">
                                    <div> <b data-toggle="tooltip" data-placement="left" title="% Média Regional">
                                        ...
                                        <font size="+1">  <?php echo  $porc_regional; ?><?php if (($flag != 'valor') && ($label !='Pacientes')) echo '%'; else if ($label == 'Pacientes') echo ''; else echo ' R$'; ?></font>
                                         </b>
                                    ...
                                    <div> <b data-toggle="tooltip" data-placement="left" title="% Média Nacional">
                                        ...
                                        <font size="+1">  <?php if (($flag != 'valor')&&($flag != 'valor-invertido')&&($label != 'Pacientes')) echo $porc_nacional.'%';
                                          else if ($label =='Pacientes') echo $porc_nacional; else echo 'R$' . number_format($porc_nacional  , 2, ',', '.'); ?>
                                         </font>
                                        </b>
