...
<head>
  ...
  <title><?php echo $nomefantasia?> FM</title>
  ...
  var data_LinFluxoFM = [
                         ['Data Referência', 'Total Clínica','Média Regional', 'Média Nacional'],
                               ...
                               ?>
                               ['<?php echo $busca_lin_fluxo_fm->dataref; ?>', <?php echo $busca_lin_fluxo_fm->total_clinical; ?>,<?php echo round($busca_lin_fluxo_fm->media_regional,0); ?>,
                                <?php echo round($busca_lin_fluxo_fm->media_nacional,0); ?>  ],
                                                           <?php }     ?>
];
      ...
      var data = google.visualization.arrayToDataTable(data_LinFluxoFM);
        ...
        var options = {
          title: '<?php echo $nomefantasia?> FM',
