...
<head>
  ...
  <title><?php echo $nomefantasia?> Fluxo de Pacientes</title>
    ...
    <script type="text/javascript">
     ...
     window.onload = function(){
      ...
      var data = google.visualization.arrayToDataTable(data_LinFluPac);
        ...
        var options = {
          title: '<?php echo $nomefantasia?>, Histórico Fluxo de Pacientes',
          hAxis: {title: 'Mês',  titleTextStyle: {color: '#333'}},
          vAxis: {minValue: 0}
        };

        var chart = new google.visualization.LineChart(document.getElementById('lin_fluxo_paciente'));
