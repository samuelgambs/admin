            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.php?id=<?php echo $_GET['id'] ?>"><i class="fa fa-dashboard fa-fw"></i> Painel</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Gráficos<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.php?id=<?php echo $_GET['id'] ?>">Gráficos</a>
                                </li>
                                <li>
                                    <a href="linha.php?id=<?php echo $_GET['id'] ?>">Detalhado Mês a Mês</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="tables.php?id=<?php echo $_GET['id'] ?>"><i class="fa fa-table fa-fw"></i> Tabelas</a>
                        </li>
                         <li>
                            <a href="clinicas.php?id=<?php echo $_GET['id']?>"><i class="fa fa-sitemap fa-fw"></i> Clínicas<span class="fa arrow"></span></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            <div id="negociacao" style="width:100%; height:50%"></div>
                  ...
                  <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                             <div id="custo_paciente" style="width:100%; height:50%"></div>
