...
"SELECT dataref,
 ...
 "SELECT  faltosos_b1, faltosos_b2, data_inclusao, faltosos_porc
 FROM cli_agendados_faltosos
 WHERE INSCRICAO = $id
 ...
 $parcial_faltosos_agendados_mp = $row_busca_parcial_faltosos_atendidos_mp->faltosos_b1;
 $parcial_porc_faltosos_agendados_mp = $row_busca_parcial_faltosos_atendidos_mp->faltosos_porc;
 $data_inclusao_mp = $row_busca_parcial_faltosos_atendidos_mp->data_inclusao;



echo montaPanel($label, $faltosos_agendados_ma, $faltosos_agendados_ma, $faltosos_agendados_regional_ma, $faltosos_agendados_nacional_ma, $parcial_faltosos_agendados_mp, $icon, $flag,
	...
	"SELECT AVG(total) as total, avg(faltosos_agendados) as faltosos_agendados,  avg(faltosos_atendidos) as faltosos_atendidos
			...
			echo montaPanel($label, $faltosos_agendados_mp, $faltosos_agendados_mp, $faltosos_agendados_regional_mp, $faltosos_agendados_nacional_mp, $faltosos_agendados_nacional_mp, 
