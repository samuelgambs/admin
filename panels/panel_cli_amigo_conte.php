...
"SELECT dataref, total_indic,total_contemplado
...
if (!empty($row_busca_cliente_amigo_ma->total_indic))
	$cliente_amigo_total_indic_ma =  $row_busca_cliente_amigo_ma->total_indic;
	else $cliente_amigo_total_indic_ma = 0;
	if (!empty($row_busca_cliente_amigo_ma->total_contemplado))
		$cliente_amigo_total_contemplado_ma =  $row_busca_cliente_amigo_ma->total_contemplado;
	else $cliente_amigo_total_contemplado_ma = 0;
	...
	if (!empty($row_busca_cliente_amigo_mp->total_indic))
		$cliente_amigo_total_indic_mp =  $row_busca_cliente_amigo_mp->total_indic;
	else
		$cliente_amigo_total_indic_mp = 0;
	if (!empty($row_busca_cliente_amigo_mp->total_contemplado))
		$cliente_amigo_total_contemplado_mp = $row_busca_cliente_amigo_mp->total_contemplado;
	else
		$cliente_amigo_total_contemplado_mp = 0;

	$sql_media_nacional_cliente_amigo_mp =
	"SELECT AVG(total_indic) as total_indic, AVG(total_contemplado) as total_contemplado
	FROM cli_lin_cliente_amigo xx
	...
	$cliente_amigo_total_contemplado_nacional_mp =  $row_media_nacional_cliente_amigo_mp->total_contemplado;
	$cliente_amigo_total_indic_nacional_mp = $row_media_nacional_cliente_amigo_mp->total_indic;
	...
	"SELECT AVG(total_indic) as total_indic, AVG(total_contemplado) as total_contemplado
			...
			$cliente_amigo_total_contemplado_regional_mp =  $row_media_regional_cliente_amigo_mp->total_contemplado;
			$cliente_amigo_total_indic_regional_mp = $row_media_regional_cliente_amigo_mp->total_indic;
...
if ($dados=='ma') {
	...
	$cliente_amigo_total_contemplado_nacional_ma =  $row_media_nacional_cliente_amigo_ma->total_contemplado;
	...
	$sql_pmp ="SELECT total_indic,total_contemplado, inscricao, data_inclusao as data_cliente_amigo_pmp
	...
	$var_parcial_mp = $row->total_contemplado;
	$data_inclusao_mp = $row->data_cliente_amigo_pmp;
	
	echo montaPanel($label, $cliente_amigo_total_contemplado_ma, $cliente_amigo_total_contemplado_ma, $cliente_amigo_total_contemplado_regional_ma, $cliente_amigo_total_contemplado_nacional_ma,
...
echo montaPanel($label, $cliente_amigo_total_contemplado_mp, $cliente_amigo_total_contemplado_nacional_mp, $porc_cliente_amigo_total_contemplado_regional, $porc_cliente_amigo_total_contemplado_nacional, $pacientes_nacional,
		 $icon, $flag,
		 $total_pac_mes_passado, $pacientes_mes_parcial, $pacientes_nacional, $pacientes_nacional, $pacientes_regional);
