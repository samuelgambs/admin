...
if ($dados=='ma') {
	...
	$var_parcial_mp = $row->total_indic;
	$data_inclusao_mp = $row->data_cliente_amigo_pmp;
	
	echo montaPanel($label, $cliente_amigo_total_indic_ma, $cliente_amigo_total_indic_ma, $cliente_amigo_total_indic_regional_ma, $cliente_amigo_total_indic_nacional_ma,
...
echo montaPanel($label, $cliente_amigo_total_indic_mp, $cliente_amigo_total_contemplado_nacional_mp, $porc_cliente_amigo_total_indic_regional, $porc_cliente_amigo_total_indic_nacional, $pacientes_nacional,
		 $icon, $flag,
